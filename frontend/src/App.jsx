...
import { validarProducto } from './utils/validarProductos'
...
function App() {
  ...
  if (Object.keys(errores).length > 0) {
    // Mostrar los errores como alerta o en pantalla
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      ...
      <div className="mb-4">
        ...
        <input type="number" placeholder="Stock" value={form.stock} onChange={(e) => setForm({ ...form, stock: e.target.value })} className="p-2 border w-full mb-2" />
