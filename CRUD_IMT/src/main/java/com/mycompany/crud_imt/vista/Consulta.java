...
public class Consulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos - Consulta"));
        ...
        tablaDATOS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "registro", "id usuario", "consulta", "id agente", "respuesta", "estado"
            }
        ));
    ...
    private void tablaDATOSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaDATOSMouseClicked
        ...
        if(fila==-1) {
            JOptionPane.showMessageDialog(null, "Consulta no Seleccionada");
        }else{
            id = Integer.parseInt((String)tablaDATOS.getValueAt(fila, 0).toString());
            String fecha = (String)tablaDATOS.getValueAt(fila, 1);
            String usuario = (String)tablaDATOS.getValueAt(fila, 2);
            String consulta = (String)tablaDATOS.getValueAt(fila, 3);
            String agente = (String)tablaDATOS.getValueAt(fila, 4);
            String respuesta = (String)tablaDATOS.getValueAt(fila, 5);
    ...
    public void listar() {
        ...
        try {
            ...
            Object[] consultation = new Object[7];
            
            modelo = (DefaultTableModel)tablaDATOS.getModel();
            
            while (rs.next()) {                
                consultation[0] = rs.getInt("id");
                consultation[1] = rs.getString("consultation_date");
                consultation[2] = rs.getString("user");
                consultation[3] = rs.getString("consultation");
                consultation[4] = rs.getString("agent");
                consultation[5] = rs.getString("answer");
                consultation[6] = rs.getString("state");
                modelo.addRow(consultation);
            }
    ...
    public void agregar() {
        ...
        String agente = txtAGENTE.getText();
        String respuesta = txtRESPUESTA.getText();
        if (usuario.equals("") || consulta.equals("") || agente.equals("") || respuesta.equals("")) {
            JOptionPane.showMessageDialog(null, "Cajas Vacias...!!!");
        } else {
            String sql = "INSERT INTO consultation (user, consultation, agent, answer) VALUES ('"+usuario+"','"+consulta+"','"+agente+"','"+respuesta+"')";
            try {
                cn = con.getConnection();
                st = cn.createStatement();
    ...
    public void modificar() {
        ...
        String agente = txtAGENTE.getText();
        String respuesta = txtRESPUESTA.getText();
        String sql = "update consultation set user='"+usuario+"', consultation='"+consulta+"', agent='"+agente+"', answer='"+respuesta+"' where id="+id;
        if (usuario.equals("") || consulta.equals("") || agente.equals("") || respuesta.equals("")) {
